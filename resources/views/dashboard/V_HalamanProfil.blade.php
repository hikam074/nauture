    ...
    <div class="mb-5 flex flex-col gap-10 w-full">
        ...
        <div class="flex gap-10 items-center">
            <div class="w-25 h-25">
                ...
                <svg width="auto" height="auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="2 2 20 20">
        ...
        @foreach (['name' => 'Nama lengkap', 'email' => 'Email', 'no_telp' => 'Nomor Telepon', 'alamat' => 'Alamat'] as $field => $label)
            <div class="">
        ...
        <div class="-mb-8">
            ...
            <div class="flex items-center gap-2">
                <input readonly
                    ...
                    class="border-1 p-2 w-full border-primer"
                    >
                <button class="bg-transparent text-transparent px-4 py-2 rounded">
                    Simpan
                </button>
            </div>
        </div>
            ...
            <form action="{{ route('profil.update') }}" method="POST">
                ...
                <div class="flex items-center gap-2">
                    <div class="flex flex-col gap-2 w-full">
                        <!--PASSWORD BARU-->
                        <label for="new_password">Set Password Baru</label>
                    ...
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded mb-12">
                        Simpan
                    </button>
                </div>
            </form>
