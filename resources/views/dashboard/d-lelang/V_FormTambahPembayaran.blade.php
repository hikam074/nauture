<div id="popupAlamat"
    class="fixed top-0 bottom-0 left-0 right-0 mt-16 hidden items-center justify-center z-1000 bg-[rgba(0,0,0,0.5)]"
>
    <form id="pengirimans" action="{{ route('transaksi.create') }}" method="POST" class="min-w-[70%] max-w-[80%]">
        @csrf
        <!--CONTENT-->
        <div id="alamatContent"
            class="w-full flex flex-col gap-5 bg-white p-6 rounded-lg shadow-lg"
            >
