                        ...
                        @foreach($ratings as $rating)
                                <li class="py-2 border-b flex justify-between items-center"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <!-- foto profil -->
                                        @if ($rating->transaksi->lelang->pemenang->user->foto_profil)
                                            <img src="{{ asset('storage/' . $rating->transaksi->lelang->pemenang->user->foto_profil) }}" alt="Foto Profil {{ $rating->transaksi->lelang->pemenang->user->foto_profil }}"
