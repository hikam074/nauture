...
@section('content')
    ...
    <section class="w-full bg-amber-800">
        <div class="w-full mx-auto relative h-[80vh] bg-cover bg-center text-white text-center
            flex flex-col justify-center items-center"
            style="background-image: url('/images/assets/homepageFill.png');">
            @if (Auth::user())
                <h1 class="text-2xl font-bold mb-2   md:text-3xl lg:text-4xl">
            ...
            @endif
            <p class="text-lg mb-4   md:text-xl lg:text-2xl">
                Dengan NauTure, pelelangan hasil panen dapat diakses kapan saja dan dimana saja
            </p>
            <a href="{{ route('lelang.index') }}"
                class=" px-5 py-3 rounded-lg shadow-lg
                font-bold text-primer bg-white hover:bg-primer hover:text-white
                transition duration-300 transform hover:shadow-xl hover:scale-105 hover:border-white"
                >
