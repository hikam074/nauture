...
@section('content')
    <!-- SELAMAT DATANG -->
    <section class="w-full bg-amber-800">
        <div class="w-full mx-auto relative h-[70vh] bg-cover bg-center text-white text-center
            flex flex-col justify-center items-center"
            style="background-image: url('/images/assets/homepageFill.png'); center center no-repeat; background-size: cover;">
            @if (Auth::user())
                <h1 class="text-2xl font-bold mb-2
                    md:text-3xl lg:text-4xl
                    ">
                    <span class="animasi-slide-keatas">Selamat </span>
                    <span class="animasi-slide-keatas">Datang, </span>
                    <span class="animasi-slide-keatas">{{ Auth::user()->name }} !</span>
                </h1>
            @else
                <h1 class="text-2xl font-bold mb-2
                    md:text-3xl lg:text-4xl
                    ...
                    <span class="animasi-slide-keatas">Selamat </span>
                    <span class="animasi-slide-keatas">Datang, </span>
                    <span class="animasi-slide-keatas">Pengunjung!</span>
                </h1>
            @endif
            <p class="text-lg mb-4
                md:text-xl lg:text-2xl
                ">
                <span class="animasi-slide-keatas">Dengan NauTure, </span>
                <span class="animasi-slide-keatas">pelelangan hasil panen dapat diakses kapan saja </span>
                <span class="animasi-slide-keatas">dan dimana saja</span>
            </p>
            <a href="{{ route('lelang.index') }}"
                class=" px-5 py-3 rounded-lg shadow-lg
                font-bold text-primer bg-white
                hover:bg-primer hover:text-white hover:scale-105 hover:border-white
                transition duration-300 transform hover:shadow-xl
    ...
    <!-- KATALOGS -->
    <section class="mx-5 mt-4 text-primer">
        ...
        <div class="relative p-2">
            <div class="flex gap-1 justify-between flex-wrap sm:justify-start sm:gap-5">
                @forelse ($katalogs->take(6) as $katalog)
                    <div onclick="window.location.href='{{ route('katalog.show', ['id' => $katalog->id]) }}'"
                        class="flex flex-col w-[49%] bg-white rounded-lg shadow-lg p-4 cursor-pointer text-center gap-1
                        ...
                        >
                        <h2 class="text-lg font-semibold">{{ $katalog->nama_produk }}</h2>
                        <p class="text-xs font-thin border-t-1 border-primer mt-auto">Mulai Rp{{ number_format($katalog->harga_perkilo, 0, ',', '.') }}/kg</p>
                    </div>
                @empty
                    <p>Produk Kosong.</p>
                @endforelse
            ...
            <div class="flex gap-1 justify-between flex-wrap sm:justify-start sm:gap-5">
                @forelse ($lelangs->take(6) as $lelang)
                    <div class="flex flex-col w-[49%] bg-white rounded-lg shadow-lg p-4 cursor-pointer text-center gap-1
                        ...
                        <p class="text-xs font-thin border-t-1 border-primer mt-auto">Harga Awal: Rp{{ number_format($lelang->harga_dibuka, 0, ',', '.') }}</p>
                    </div>
                @empty
    ...
    <section class="text-center">
        <div class="mx-auto mt-8 flex flex-col items-top gap-12 p-6 md:flex-row">
            <div class="flex-1 flex flex-col gap-4">
                <!-- Logo, Judul -->
                <div class="flex flex-col items-center">
                    <img src="{{ asset('images/logos/roundLogo.png') }}" alt="[Logo]"
                        class="w-16 h-16 object-contain">
                    <h3 class="text-4xl  font-bold">Kenapa Harus NauTure?</h3>
                </div>
                <!-- Deskripsi -->
        ...
        <div class="flex flex-col text-center gap-4 p-10
            md:flex-row md:items-stretch
            ">
            <!-- FLEX TRANSPARANSI -->
            <div class="border-2 p-10 flex flex-col items-center
            ...
            <div class="border-2 p-10 flex flex-col items-center
                ...
                animasi-slide-keatas
                ">
                <svg id="Layer_1" height="64px" width="64px" style="enable-background:new 0 0 256 256;" version="1.1" viewBox="0 0 256 256" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g>
