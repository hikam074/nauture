<div class="border border-border rounded-lg bg-background p-6 shadow-sm">
    <div class="prose prose-sm md:prose-base lg:prose-lg max-w-none prose-headings:font-bold prose-a:text-blue-600" style="user-select: none;">
        <div align="center" class="text-center">
            ...
            >
            <!-- TOP LANGUANGE -->
            <img alt="repo-top-language" class="inline-block mx-1" style="margin: 0px 2px;"
                src="https://img.shields.io/github/languages/top/hikam074/nauture?style=flat&amp;color=0080ff"
            >
            <!-- LANGUANGE COUNT -->
            <img alt="repo-language-count" class="inline-block mx-1" style="margin: 0px 2px;"
                src="https://img.shields.io/github/languages/count/hikam074/nauture?style=flat&amp;color=0080ff"
            >
            <p><em>Built with the tools and technologies:</em></p>
            <!-- LARAVEL -->
            <img alt="Laravel" class="inline-block mx-1" style="margin: 0px 2px;"
                src="https://img.shields.io/badge/Laravel-FF2D20.svg?style=flat&logo=laravel&logoColor=white"
            >
            <!-- PHP -->
            ...
            >
            <!-- TAILWINDCSS -->
            <img alt="Tailwind CSS" class="inline-block mx-1" style="margin: 0px 2px;"
                src="https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=flat&logo=tailwind-css&logoColor=white"
            >
            <!-- VITE -->
            <img alt="Vite" class="inline-block mx-1" style="margin: 0px 2px;"
                src="https://img.shields.io/badge/Vite-646CFF.svg?style=flat&logo=Vite&logoColor=white"
            >
            <!-- AXIOS -->
            ...
            >
            <!-- ONESIGNAL -->
            <img alt="OneSignal" class="inline-block mx-1" style="margin: 0px 2px;"
